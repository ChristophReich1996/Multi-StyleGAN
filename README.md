...
![latent space interpolation](github/latent_space_interpolation.gif "latent space interpolation")
...
Samples generated by Multi-StyleGAN. Brightfield channel on the top and green fluorescent protein on the bottom.
